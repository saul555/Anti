...
?>
                   ...
                   <label class="form-label">Material</label>
                    <input type="text" class="form-control" name="nombre"     value="<?php echo $row1->nombre; ?>"           required="" >
    
                  </div>
                   <div class="mb-3">
    <label class="form-label">cantidad</label>
    <input type="number" class="form-control" name="cantidad"  value="<?php echo $row1->cantidad; ?>"  required="" >
...
<div class="mb-3">
    <label  class="form-label">Unidad de medida</label>
      ...
      <select  class="form-control"  name="unidadMedida"  value="<?php echo $row1->unidadMedida; ?>"  required="">
