...
<h2>Lista Aulas</h2>
     ...
     <?php 
            echo form_open_multipart('aulas/agregar');
                             ?>

           <button type="submit " class="btn btn-primary mb-3">Agregar Aulas </button>
       <?php 
          echo form_close();
          ...
          <nav id="orders-table-tab" class="orders-table-tab app-nav-tabs nav shadow-sm flex-column flex-sm-row mb-4">
            ...
            <a class="flex-sm-fill text-sm-center nav-link active" id="orders-all-tab" data-bs-toggle="tab" href="#orders-all" role="tab" aria-controls="orders-all" aria-selected="true">Aulas</a>
                    ...
                    <thead>
                      <tr>
                        ...
                        <th class="cell" scope="col">Nombre</th>
                         ...
                         <th class="cell"scope="col">Capacidad</th>
                          <th class="cell"scope="col">Limite Covid</th>
                         
                         
                         
                          <th class="cell"scope="col">Registro Desinfeccion</th>
...

{
  ...
  ?>
    <tr>
      ...
      <td><?php echo $row->limiteCovid; ?></td>
      ...
      <td>
        <?php 
         echo form_open_multipart('registroD/index');
         ?>
        <input type="hidden" name="idaulas" value="<?php echo $row->idaulas; ?>">
       
         <button type="submit " class="btn btn-success btn-xs">Registro Desinfeccion</button>
        <?php 
          echo form_close();
      ...
      <td>
        <?php 
         echo form_open_multipart('aulas/modificar');
         ?>
        <input type="hidden" name="idaulas" value="<?php echo $row->idaulas; ?>">
      ...
      <td>
        <?php 
         echo form_open_multipart('aulas/Eliminarbd');
         ?>
        <input type="hidden" name="idaulas" value="<?php echo $row->idaulas; ?>">
  ...
  ?>
    <tr>
      ...
      <td>
        ...
        <button type="submit " class="btn btn-danger btn-xs">Elimittnar</button>
        <?php 
          echo form_close();
