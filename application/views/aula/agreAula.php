        ...
        <div class="container-xl">          
                ...
                <div class="row g-4 settings-section">
                  <div class="col-12 col-md-2">
                    <h3 class="section-title">Agregar Aulas</h3>

                    <div class="section-intro">Sea Responsable  </div>


                    <h4 class="section-title">limite Covid es:</h4>
...
{
?>                 
                  <option><?php echo $row->limteCovid ."%";?>                         
                  </option>                
<?php
}
?> 
...
<?php
   ...
   echo form_open_multipart('aulas/agregarbd');
  ?>
...
<div >
    <label class="text-muted" >Capacidad total de las Personas</label>
